...
The gollum-site gem requires Nokogiri. If you are using the Nitrous.io hosted development environment, install Nokogiri befoe installing the gollum-site gem.
